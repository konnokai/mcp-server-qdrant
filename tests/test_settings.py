...
class TestToolSettings:
    def test_default_values(self):
        ...
        assert settings.tool_delete_description == DEFAULT_TOOL_DELETE_DESCRIPTION
    ...
    def test_custom_delete_description(self, monkeypatch):
        """Test loading custom delete description from environment variable."""
        monkeypatch.setenv("TOOL_DELETE_DESCRIPTION", "Custom delete description")
        settings = ToolSettings()
        assert settings.tool_store_description == DEFAULT_TOOL_STORE_DESCRIPTION
        assert settings.tool_edit_description == DEFAULT_TOOL_EDIT_DESCRIPTION
        assert settings.tool_delete_description == "Custom delete description"
        assert settings.tool_find_description == DEFAULT_TOOL_FIND_DESCRIPTION
