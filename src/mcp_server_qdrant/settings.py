...
DEFAULT_TOOL_EDIT_DESCRIPTION = (
    "Update an existing memory in Qdrant by its point ID when stored information "
    "needs to be corrected or refreshed."
)
DEFAULT_TOOL_DELETE_DESCRIPTION = (
    "Delete an existing memory from Qdrant by its point ID."
)
